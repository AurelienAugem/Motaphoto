            ...
            <ul id="menu-categorie" class="show-filter filter-hide">
                <?php foreach ($categories as $categorie) : ?>
                    <li value="<?php echo $categorie->name; ?>">
                        <a class="photo-categorie" id="<?php echo $categorie->slug ?>" data-type="categorie" data-slug="<?php echo $categorie->slug ?>">
            ...
            <ul id="menu-format" class="show-filter filter-hide">
                <?php foreach ($formats as $format) : ?>
                    <li value="<?php echo $format->name; ?>">
                        <a class="photo-format" id="<?php echo $format->slug ?>" data-type="format" data-slug="<?php echo $format->slug ?>">
    ...
    <div class="btn-filters">
        <div id="filtre-date" name="tri">
            ...
            <ul id="menu-tri" class="show-filter filter-hide">
                <li><a class="photo-date" data-type="date" data-slug="ASC">plus anciennes aux plus récentes</a></li>
                <li><a class="photo-date" data-type="date" data-slug="DESC">plus récentes aux plus anciennes</a></li>
            </ul>
        </div>
    </div>
</div>    